...
- `09 - September 2026/` — 2026-09-18 onward. The vault's first day.
  ...
  - [[2026-09-21]] — **nineteen sessions, the longest day in the vault.** Overnight: the winner-post template, the school campaign and the QR correction, the spoken voice and its licence trap, the voice cast, Mahmoud's rates, the month-1 asset brief and posting calendar. Morning: the Alex Foods marketing plan, the El Ghaly Motors pitch, the stranded branches, and the named approver dropped on purpose. Afternoon: the live client asks split by owner and a Saturday caught in the money message, then **the Foundation book handed to a designer** and the brief written for him.
  - [[2026-09-22]] — **what TSA needs back from Mahmoud before he starts.** The commercial conversation split off from the design brief: seven asks ranked by what leaving them open costs, the walk-away number reasoned off his own rate rather than invented market pricing, and the kit's money kept separate from the month's.
  - [[2026-09-23]] — **Local SEO built**, deliverable 8, from a footprint audit that found a lapsed website, a second Facebook address and three legal names. The Facebook and Instagram bios written for the first time. Graphify added as a skill. Also found a stranded day of 22 Sep work that had never reached `main`.
  - [[2026-09-24]] — **eleven commits recovered off a stranded branch.** The queue said every session branch was contained in `main`; two were not, and deleting on its word would have destroyed the whole 22 September day and three notes. Merged, verified clean, and the item rewritten with the real count.
