...
- [ ] **Paper the POLEKA inclusion.** Decided 18 Sep: POLEKA is in the Foundation, four brands, no change to fee. The signed scope names three and doesn't mention it, and clause 4's rejection rule leans on the approved guide matching that scope. One line in writing from them closes it. (tsa)
- [ ] **Get two answers from the client — down from four, and send them in one message today.** (1) What "Alex" is: a seal on AlRawy and 2MAN but not BeBo or POLEKA, and the answer decides whether the system carries a house layer and how every bio reads. (2) Whether they hold rights to the "Cola Cola" artwork TSA would be pushing in paid campaigns. **The other two are dead:** both 2MAN designs are live (a sub-brand rule, not a question), and there are no colour codes or font names to collect — setting them is the deliverable. Full detail in [[Alex Foods Brands]]. (tsa)
