...
- **Verify the date.** Check the actual system date before writing a date into anything permanent; a conversation can stay open overnight. **This one bites here more than most:** I'm in Egypt (Africa/Cairo) and I sleep around 8 AM, so most of my sessions run through the night and cross midnight mid-conversation. The machine you run on may well be on UTC. Convert to Cairo time before you write a date or a timestamp anywhere.
