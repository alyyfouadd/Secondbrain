...
- [ ] **Brief Mahmoud, and agree his rate against the 20,000.** **Answered 20 Sep: two documents** — he builds a separate visual kit and guidelines, TSA keeps the Foundation book ([[Decisions]] #27). **The brief IS the deliverable**: page list, section content, colour values by name, type scale, the seal answer, format, revision rounds, deadline, filenames. His rate is still unknown and it is now a cost against a fee that had none. (tsa)
...
- [ ] **Replace animation A1.** "The jug" is dead — the pack reads 75 ml, ready to drink ([[Decisions]] #30). **One of the two month-1 animations now has no idea behind it.** [[Content Plan]] §5 (tsa)
