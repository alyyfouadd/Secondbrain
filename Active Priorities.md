...
- [ ] **Settle the POLEKA question before anything gets built for it.** Four brands arrived against a three-brand scope: BeBo, AlRawy and 2MAN are named, POLEKA is not. Clause 7 says it gets quoted and agreed in writing or it stays out. A fourth brand is a fourth voice, a fourth colour system and a fourth share of every monthly deliverable at no extra fee. (tsa)
- [ ] **Get four answers from the client before the Foundation can finish:** which 2MAN design is live (two different ones arrived), what "Alex" is (a seal on AlRawy and 2MAN but not BeBo or POLEKA), the exact colour codes and font names from whoever designed the packaging, and whether they hold rights to the "Cola Cola" artwork TSA would be pushing in paid campaigns. Full detail in [[Alex Foods Brands]]. (tsa)
...
- [ ] Get Brand Foundation signed off **in writing** — Package A's month 1 counts from that approval date, not from the payment date. Until it happens, the received 42,000 is money for a month that hasn't started. (tsa)
