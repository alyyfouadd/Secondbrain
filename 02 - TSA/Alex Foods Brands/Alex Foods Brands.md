...
- `Alex Foods - Brand and Social Kit v1.0.pdf` — **Foundation deliverable 3 in kit form**, 6 pages, A4. TSA's own kit layout rebuilt in Alex Foods' colours and bilingual: identity, architecture, profile and sizes, post and story templates, the rules, content mix and posting rhythm. Written up in [[Brand and Social Kit]].
- [[Brand and Social Kit]] — what the kit is, the computed colour mapping against TSA's own relationships, why the content mix is not TSA's, where every Arabic line came from, and the two things the kit deliberately does not do.
