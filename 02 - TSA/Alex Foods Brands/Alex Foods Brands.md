...
- `design-system/field.pdf` — **book section 12 built and proven**, 4 pages, from `field.py`. **Not a deliverable** — it is the book's pack-in-field section, rendered and checked before the rest of the book is poured into the template. Its findings are governed in [[Colour System]] §10b.
