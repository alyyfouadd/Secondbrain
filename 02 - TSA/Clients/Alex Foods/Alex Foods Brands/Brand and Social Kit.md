...
**Aly, 19 September, with `SWAG-Design-System.pdf` *(external reference, not in this vault)* as the reference: *"the kit should contain everything like this one, shouldn't be for a site but it has everything in it."***
