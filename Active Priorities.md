...
- [ ] **Build the brand book** — the A4 PDF all eight deliverables ship inside. Format, grid, type, bilingual rules and page-by-page architecture are specified in [[Brand Book Spec]]; build the template's five page types and render-test them before pouring 60 pages into an untested shell. (tsa)
