...
- [ ] **Confirm which BeBo brand line is live.** [[Decisions]] carries two settled the same day — «بيبو معاك كل يوم» and «مع بيبو، اليوم أحلى» — and the later says the first is dead. **Reading list order says the second, but that is inference, not a dated record.** Nothing in the vault should state a BeBo line until you answer. One word closes it. (tsa)
...
- [ ] **Two brand lines outstanding:** «الراوي.. طعم تثق فيه» and POLEKA's. **POLEKA should take «اجمعهم مع بوليكا», not «مع بوليكا، اللعب أحلى», and the reason is set-level** — the master owns **مع + أحلى**, a second line in that construction is a family, a third stops reading as a system. The imperative also does POLEKA's collection job. [[Slogans and Song]] §5c (tsa)
...
- [ ] **The parked giveaway song has a broken last line.** It bookended on a line that was replaced. Parked at Aly's instruction, so nothing is on fire; whoever picks it up rebuilds line 4. [[Slogans and Song]] §5d (tsa)
