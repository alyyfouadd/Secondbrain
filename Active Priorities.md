...
- [ ] **Rebuild the architecture on the umbrella model.** [[Colour System]] §2 layer 1, the design system's architecture page, and deliverable 3's page plan were all written for a selective endorser. One Alex Foods presence changes all three. (tsa)
